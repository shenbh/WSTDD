 ...
 */
@SuppressLint("NewApi")
public class GroupViewPager extends Fragment implements OnPageChangeListener {
	
	private List<ImageView> imageViews = new ArrayList<ImageView>();
	private ImageView[] indicators;
	private FrameLayout viewPagerFragmentLayout;
	private LinearLayout indicatorLayout; // 指示器
	private GroupBaseViewPager viewPager;
	private GroupBaseViewPager parentViewPager;
	private ViewPagerAdapter adapter;
	private GroupViewPagerHandler handler;
	...
	private GroupCycleListener mGroupCycleListener;
	private List<HotGroupListInfo> infos;

	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {
		View view = LayoutInflater.from(getActivity()).inflate(
				R.layout.view_cycle_viewpager_contet_first, null);

		viewPager = (GroupBaseViewPager) view.findViewById(R.id.viewPager);
		...
		handler = new GroupViewPagerHandler(getActivity()) {
...
//					}
	...
	public void setData(List<ImageView> views, List<HotGroupListInfo> list, GroupCycleListener listener) {
	 ...
	 *            默认显示位置
	 */
	public void setData(List<ImageView> views, List<HotGroupListInfo> list, GroupCycleListener listener, int showPosition) {
		mGroupCycleListener = listener;
		infos = list;
...
//			}
		...
		for (int i = 0; i < indicators.length; i++) {
			View view = LayoutInflater.from(getActivity()).inflate(
					R.layout.view_cycle_viewpager_indicator_first, null);
	 ...
	 * @return viewPager
	 */
	public GroupBaseViewPager getViewPager() {
		return viewPager;
	}
	...
	private class ViewPagerAdapter extends PagerAdapter {
		...
		//这里是针对的是控件或者fragment的  要是执行的话会先执行这块，从而覆盖了后面的内容
//		@Override
//		public View instantiateItem(ViewGroup container, final int position) {
//			ImageView v = imageViews.get(position);
//			if (mGroupCycleListener != null) {
//				v.setOnClickListener(new OnClickListener() {
//					
//					@Override
//					public void onClick(View v) {
//						mGroupCycleListener.onImageClick(infos.get(currentPosition - 1), currentPosition, v);
//					}
//				});
//			}
//			container.addView(v);
...
//			return views.get(arg1);
			View view=View.inflate(getActivity(), R.layout.view_cycle_viewpager_contet_first_viewpager, null);
			TextView textView=(TextView) view.findViewById(R.id.sale_number);
			textView.setText("sadasdsad");	
			ImageView imageView=(ImageView) view.findViewById(R.id.image);
			imageView.setImageDrawable(getResources().getDrawable(R.drawable.test_item05));
...
//		}
	 ...
	 */
	public void disableParentViewPagerTouchEvent(GroupBaseViewPager parentViewPager) {
		if (parentViewPager != null)
	 ...
	 * @author minking
	 */
	public static interface GroupCycleListener {
